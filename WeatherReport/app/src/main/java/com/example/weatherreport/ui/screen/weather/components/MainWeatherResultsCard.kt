package com.example.weatherreport.ui.screen.weather.components
...
@Composable
fun MainWeatherCard(weatherResults: WeatherData) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .padding(top = 0.dp),
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = getWeatherEmoji(weatherResults.weather?.firstOrNull()?.main ?: stringResource(
                        R.string.clear
                    )),
                    fontSize = 24.sp,
                    color = Color.White
