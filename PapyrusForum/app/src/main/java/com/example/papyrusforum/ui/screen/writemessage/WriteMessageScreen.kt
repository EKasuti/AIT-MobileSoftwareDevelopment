package com.example.papyrusforum.ui.screen.writemessage
...
fun WriteMessageScreen(
    ...
    // file path of the image that's stored locally
    ...
    Column(
        ...
        OutlinedButton(
            onClick = {
                if(imageUri == null) {
                    viewModel.uploadPost(postTitle, postBody)
                } else {
...
class ComposeFileProvider : FileProvider(
    com.example.papyrusforum.R.xml.filepaths
) {
    companion object {
