...
fun LoginScreen(
    ...
    var email by rememberSaveable { mutableStateOf("bigk@papyrus.com") }
    ...
    Box() {
        ...
        Column(
            ...
            when(viewModel.loginUiState) {
                ...
                is LoginUiState.LoginSuccess -> Text("Login Success")
                is LoginUiState.RegisterSuccess -> Text("Register Success")
            }
        }
    }
}